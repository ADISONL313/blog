<template>
    <el-form ref="ruleFormRef" :model="SignInForm" :rules="rules" class="modern-form">
        <el-form-item prop="mail" class="form-item">
            <el-input placeholder="邮箱" v-model="SignInForm.mail" class="input-style"
        ...
        <el-form-item class="button-item">
            <el-button type="primary" @click="handleSignUp(ruleFormRef as any)" class="primary-btn"
                :hover-effect="false">
                登录
            </el-button>
        </el-form-item>
